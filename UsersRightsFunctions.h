...
#ifndef UsersRightsFunctionsH
#define UsersRightsFunctionsH
//---------------------------------------------------------------------------
...
class TGridFrame * __fastcall createUsersRFrame(TComponent* Owner,AnsiString iniFN,AnsiString iniSN,FBDatabase *fbDB,TPanel *workPanel);
