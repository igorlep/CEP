...
#ifndef VozvratNMPFunctionsH
#define VozvratNMPFunctionsH
//---------------------------------------------------------------------------
#include "GridF.h"
//---------------------------------------------------------------------------
//Фрейм со списываемой газетно-журнальной продукцией
// - функция формирования select sql запроса
AnsiString __fastcall formVNMPSelectSQL(bool showAllNMP,AnsiString pID,TDateTime date1,TDateTime date2);
// - функция формирования search sql запроса
AnsiString __fastcall formVNMPSearchSQL(bool showAllNMP,AnsiString pID,TDateTime date1,TDateTime date2);
