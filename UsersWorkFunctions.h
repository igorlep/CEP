...
#ifndef UsersWorkFunctionsH
#define UsersWorkFunctionsH
//---------------------------------------------------------------------------
...
class TRBFrame * __fastcall createUsersFrame(TComponent* Owner,AnsiString iniFN,AnsiString iniSN,FBDatabase *fbDB,TPanel *workPanel);
// -- фрейм с деревом прав пользователей
class TDBTreeViewFrame * __fastcall createUsersTVFrame(TComponent* Owner,AnsiString iniFN,FBDatabase *fbDB,TPanel *workPanel);
