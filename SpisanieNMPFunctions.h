...
#ifndef SpisanieNMPFunctionsH
#define SpisanieNMPFunctionsH
//---------------------------------------------------------------------------
#include "GridF.h"
//---------------------------------------------------------------------------
//Фрейм со списываемой газетно-журнальной продукцией
// - функция формирования select sql запроса
AnsiString __fastcall formNMPSelectSQL(bool showAllNMP,AnsiString nmpID,bool delDistrRecords,int stavkaNDS,TDateTime date1,TDateTime date2);
// - функция формирования search sql запроса
AnsiString __fastcall formNMPSearchSQL(bool showAllNMP,AnsiString pID,bool delDistrRecords,int stavkaNDS,TDateTime date1,TDateTime date2);
